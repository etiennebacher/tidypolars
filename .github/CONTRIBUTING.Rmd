...
for documentation.
*  tidypolars uses [testthat](https://cran.r-project.org/package=testthat). Adding
   tests to the PR makes it easier for me to merge your PR into the code base.
*  If your PR is a user-visible change, you may add a bullet to the top of `NEWS.md` 
...
Finally, the only left to do is to add some tests in the `tests/tinytest` folder.
