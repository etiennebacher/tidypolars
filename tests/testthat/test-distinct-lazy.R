...
test_that("duplicated_rows() works", {
  ...
  expect_equal_lazy(
    ...
    test[
      duplicated(test[, c("iso_o", "iso_d")]) |
        duplicated(test[, c("iso_o", "iso_d")], fromLast = TRUE),
    ]
  )
  ...
  expect_equal_lazy(
    ...
    test[
      duplicated(test[, "iso_d", drop = FALSE]) |
        duplicated(test[, "iso_d", drop = FALSE], fromLast = TRUE),
    ]
  )
})
