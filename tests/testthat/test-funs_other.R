...
test_that("n_distinct() works", {
  test <- neopolars::pl$DataFrame(x = c("a", "a", "b", "b"), y = c(1:3, NA))
...
test_that("all() works", {
  test <- neopolars::pl$DataFrame(x = c(TRUE, FALSE, NA), y = c(TRUE, TRUE, NA))
...
test_that("round() works", {
  test <- neopolars::pl$DataFrame(x = c(0.33, 0.5212))
...
test_that("dense_rank() works", {
  ...
  test2 <- neopolars::pl$DataFrame(x = numeric(0), y = numeric(0))
...
test_that("row_number() works", {
  ...
  test3 <- neopolars::pl$DataFrame(x = numeric(0), y = numeric(0))
