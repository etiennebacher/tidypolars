...
* `arrow`: one of the closest alternative to `tidypolars`. Also has lazy evaluation and query optimizations, uses Acero in the background to translate dplyr queries to `arrow`.
