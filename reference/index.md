...
- [`show_query(`*`<polars_data_frame>`*`)`](https://tidypolars.etiennebacher.com/reference/show_query.polars_data_frame.md)
  [`show_query(`*`<polars_lazy_frame>`*`)`](https://tidypolars.etiennebacher.com/reference/show_query.polars_data_frame.md)
